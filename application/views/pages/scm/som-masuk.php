        ...
        <div class="col col-xl-10 col-md-10 m-0 p-0">
            <div class="menu__right">
                ...
                <div class="menu__right--wrapper">
                    ...
                    <div class="d-block ms-auto">
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url(); ?>transactions/incoming">Masuk</a></li>
                    ...
                    <div class="row mb-lg-5 mb-2 mt-lg-4 pt-lg-2 transaction js-trans-som js-trans-som-masuk">
                                ...
                                <div class="card text-left">
                                    <div class="card-header">
                                        <div class="d-flex gap-3 scm-header-menu">
                                            ...
                                            <a class="d-block" href="<?= base_url(); ?>transaksi/distribusi/vsom?som_th_code=<?= $trans_header[0]->trans_code ?? '-'; ?>" title="Tindak-lanjut"><i class="bi bi-file-earmark-arrow-up-fill fs-3 px-1"></i></a>
