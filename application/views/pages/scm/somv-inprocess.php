        ...
        <div class="col col-xl-10 col-md-10 m-0 p-0">
            <div class="menu__right">
                ...
                <div class="menu__right--wrapper">
                    ...
                    <div class="row mb-lg-5 mb-2 mt-lg-4 pt-lg-2 transaction js-trans-somv js-trans-somv-inprocess">
                        <div class="col col-12 col-lg-12">
                            <form id="somvInprogressSubmit" enctype="multipart/form-data" method="POST">
                                <div class="card text-left">
                                    <div class="card-header">
                                        <div class="d-flex gap-3 scm-header-menu">
                                            <button disabled type="button" title="Add Record" href="#somAddProduct" data-bs-target="#somAddProduct" data-bs-toggle="modal"><i class="bi bi-file-earmark-plus-fill fs-3"></i></button>
                                            <button disabled type="submit" name="save" title="Simpan"><i class="bi bi-save2-fill fs-3"></i></button>
                                            <button disabled type="submit" name="send" title="Kirim"><i class="bi bi-send-check-fill fs-3"></i></button>
                                            <button disabled type="submit" name="reject"  title="Menolak"><i class="bi bi-file-earmark-x-fill fs-3"></i></button>
                                            <button disabled type="submit" title="Tindak-lanjut"><i class="bi bi-file-earmark-arrow-up-fill fs-3"></i></button>
                                    ...
                                    <div class="card-body print-area" id="transaction-content">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col col-lg-4">
                                                    <input type="text" class="form-control"
                                                        name="trans_code"  value="<?= $trans_header[0]->trans_code; ?>" readonly/>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col col-lg-2">
                                        ...
                                        <div class="transaction__detail">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col col-lg-4">
                                                    <input class="form-control js-ref-doc-id" type="hidden" value="<?= $trans_header[0]->ref_doc; ?>" /> 
                                                    <input class="form-control" readonly type="text" value="<?= $trans_header[0]->s2; ?>" />
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col col-lg-2">
