                    ...
                    <div class="d-block ms-auto">
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Penerimaan Produk (SOM)</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- end breadcrumb -->

                    <div class="row mb-lg-5 mb-2 mt-lg-4 pt-lg-2 transaction js-trans-por">
                        <div class="col col-12 col-lg-12">
                            <form id="porSubmit" enctype="multipart/form-data" method="POST">
                                <div class="card text-left">
                                    <div class="card-header">
                                        <div class="d-flex gap-3 scm-header-menu">
                                            <button type="button" title="Add Record" href="#porAddProduct" data-bs-target="#porAddProduct" data-bs-toggle="modal"><i class="bi bi-file-earmark-plus-fill fs-3"></i></button>
                                    ...
                                    <div class="card-body print-area" id="transaction-content">
                                        ...
                                        <div class="transaction__detail">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col col-lg-4">
                                                    <select class="form-control js-por-ditujukan">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                ...
                                                <div class="col col-lg-4">
                                                    <select class="form-control js-por-permintaan">
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col col-lg-2" style="max-width:200px;">
                                                    <input type="date" name="date_expected" class="form-control js-por-date-expect" autocomplete="on" />
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col col-lg-2">
                                                ...
                                                <div class="col col-lg-4">
                                                    <textarea class="form-control js-por-notes" name="notes" rows="1"></textarea>
                                                </div>
                                            </div>
                                            <hr />
                                            <div class="row mt-4">
