        ...
        <div class="col col-xl-10 col-md-10 m-0 p-0">
            <div class="menu__right">
                ...
                <div class="menu__right--wrapper">
                    ...
                    <div class="d-block ms-auto">
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url(); ?>transactions/inprogress">Daftar Transaksi Penerimaan Produk (SOM)</a></li>
                    ...
                    <div class="row mb-lg-5 mb-2 mt-lg-4 pt-lg-2 transaction js-trans-por js-trans-por-inprogress">
                                ...
                                <div class="card text-left">
                                    ...
                                    <div class="card-body print-area" id="transaction-content">
                                        <div class="trans-title">
                                            <h4 class="fw-bold mb-4 mb-lg-2">Penerimaan Produk</h4>
                                        </div>
