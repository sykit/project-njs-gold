                    ...
                    <div class="d-block ms-auto">
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url(); ?>transactions/complete">Selesai (<?php echo sizeof($complete_list); ?>)</a></li>
                            </ol>
                        </nav>
                    </div>
                    <!-- end breadcrumb -->
                                ...
                                <div class="transaction__detail">
                                    <div class="table-responsive mt-5 ">
                                        <table class="table table-strip">
                                            ...
                                            <tbody>
                                                <?php
                                                    if(isset($complete_list)) {
                                                        foreach($complete_list as $item){
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $item->surname ?? '-';?></td>
                                                        <td>
                                                        <a href="<?= base_url(); ?>transaksi/<?= $item->alias; ?>/<?= trim($item->activity_code); ?>/complete?th_code=<?= trim($item->trans_code); ?>" class="btn btn-outline-secondary btn-sm"><?= transBadgeId($item->trans_status_id) ?? '-';?></a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                        }
                        ...
                        <div class="row mb-lg-5 mb-2 mt-lg-4 pt-lg-2 transaction js-trans-som">
                            <div class="col col-12 col-lg-12">
                                <div class="alert alert-warning p-2">
                                    Data Transaksi Selesai Tidak Teredia.
                                </div>
                            </div>
                        </div>
                    <?php
