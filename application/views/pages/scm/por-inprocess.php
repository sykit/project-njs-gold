                    ...
                    <div class="d-block ms-auto">
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url(); ?>transactions/inprocess">Dalam Proses</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><?= $trans_header[0]->trans_code ?? '-'; ?></li>
                            </ol>
                        </nav>
                    </div>
                    <!-- end breadcrumb -->

                    <div class="row mb-lg-5 mb-2 mt-lg-4 pt-lg-2 transaction js-trans-por js-trans-por-inprocess">
                        <div class="col col-12 col-lg-12">
                            <form id="somSubmit" enctype="multipart/form-data" method="POST">
                                <div class="card text-left">
                                    <div class="card-header">
                                        <div class="d-flex gap-3 scm-header-menu">
                                            <button type="button" title="Add Record" href="#somAddProduct" data-bs-target="#somAddProduct" data-bs-toggle="modal" disabled><i class="bi bi-file-earmark-plus-fill fs-3"></i></button>
                                            <button type="submit" name="save" title="Simpan" disabled><i class="bi bi-save2-fill fs-3"></i></button>
                                            <button type="submit" name="send" title="Kirim" disabled><i class="bi bi-send-check-fill fs-3"></i></button>
                                            <button type="submit" name="reject" title="Menolak" disabled><i class="bi bi-file-earmark-x-fill fs-3"></i></button>
                                            <button type="submit" name="followup" title="Tindak-lanjut" disabled><i class="bi bi-file-earmark-arrow-up-fill fs-3"></i></button>
                                    ...
                                    <div class="card-body print-area" id="transaction-content">
                                        ...
                                        <div class="transaction__detail">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col col-lg-2">
                                                    <label>
                                                        Nomor Alokasi Produk
                                                    </label>
                                                </div>
                                                <div class="col col-lg-4" >
                                                    <input type="text" name="date_expected" disabled class="form-control" value="<?= $trans_header2[0]->trans_code; ?>"/>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col col-lg-2">
                                                ...
                                                <div class="col col-lg-4" >
                                                    <input type="text" name="date_expected" disabled class="form-control" value="<?= $company[0]->company_type_name; ?>"/>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col col-lg-2">
                                                ...
                                                <div class="col col-lg-4" >
                                                    <input type="text" name="date_expected" disabled class="form-control" value="<?= $company[0]->company_code; ?>"/>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col col-lg-2">
                                                ...
                                                <div class="col col-lg-4" >
                                                    <input type="text" name="date_expected" disabled class="form-control" value="<?= $total_berat[0]->total_berat; ?>"/>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col col-lg-2">
                                                ...
                                                <div class="col col-lg-4">
                                                    <textarea class="form-control js-por-notes" name="notes" rows="1" disabled><?= $trans_header2[0]->notes; ?></textarea>
                                                </div>
                                            </div>
                                            <hr />
                                            <div class="row mt-4">
                                            ...
                                            <div class="table-responsive mt-5 js-table-order">
                                                <table class="table table-strip js-table-order-por">
                                                    <thead>
                                                        <th>No</th>
                                                        <th>Nomor Model</th>
                                                        <th>Kategori</th>
                                                        ...
                                                        <th>Kode Sepuh</th>
                                                        <th>Ukuran</th>
                                                        <th>Jumlah Alokasi (pcs)</th>
                                                        <th>Berat Alokasi (gr)</th>
                                                    </thead>
                                                    <tbody class="js-table-order-body-inprocess">
...
<script src="<?= base_url(); ?>public/js/scm/som/por.js"></script>
