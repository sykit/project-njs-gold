        ...
        <div class="col col-xl-10 col-md-10 m-0 p-0">
            <div class="menu__right">
                ...
                <div class="menu__right--wrapper">
                    ...
                    <div class="d-block ms-auto">
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url(); ?>transactions/complete">Selesai</a></li>
                    ...
                    <div class="row mb-lg-5 mb-2 mt-lg-4 pt-lg-2 transaction js-trans-som js-trans-som-complete">
                                ...
                                <div class="card text-left">
                                    <div class="card-header">
                                        <div class="d-flex gap-3 scm-header-menu">
                                            ...
                                            <button name="print" name="print" title="Cetak"><i class="bi bi-printer-fill fs-3"></i></button>
                                        </div>
                                    </div>
                                    <div class="card-body print-area" id="transaction-content">
                                        <div class="trans-title">
                                            <h4 class="fw-bold mb-4 mb-lg-2">Selesai</h4>
                                        </div>
                                        ...
                                        <div class="transaction__detail">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col col-lg-2" style="max-width:200px;">
                                                    <input type="text" name="date_expected" class="form-control js-som-date-expect" disabled />
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col col-lg-2">
                                                ...
                                                <div class="col col-lg-4">
                                                    <textarea class="form-control js-som-notes" name="notes" rows="1" disabled><?= $trans_header[0]->notes; ?></textarea>
                                                </div>
                                            </div>
                                            <hr />
                                            <div class="row mt-4">
                                            ...
                                            <div class="table-responsive mt-5 js-table-order">
                                                <table class="table table-strip js-table-order-som">
                                                    ...
                                                    <tbody class="js-table-order-body-complete">
